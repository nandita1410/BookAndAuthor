...
<body>
	...
	<header style="background-image: linear-gradient(#AFAEFD, #efe8de);">
		<H3 class="text-center my-10" style="padding-top: 10px">Book
			Details</H3>
		<span class="navbar-brand mb-0 h1"
			style="font-color: #6AABD2; font-size: 20px">Welcome!<c:out
				value=" ${user.username}"></c:out></span> <a href="logout"
			style="float: right; font-size: 20px">Logout</a>
	</header>
	...
	<div class="container">
		<fieldset class="scheduler-border">
			...
			<div class="container-fluid" style="align-content: center">
				<table class="table table-bordered table-condensed" id="bookList"
            ...
            %>
						<tr>
							...
							BookService bookService = new BookServiceImpl(); 
							List<Book> bookDetails = bookService.getBookDetails();
							 for(Book book : bookDetails) { bookCode = book.getBookcode();
							bookName = book.getBookname(); author = book.getAuthor();
							dateadded = book.getDateadded();>
							@copyright 2020-2021 Fresher Training
							</H4>
							</footer>
							</div>
</body>
