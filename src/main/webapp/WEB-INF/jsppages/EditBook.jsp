...
<header style="background-image: linear-gradient(#AFAEFD, #efe8de);">
		<H3 class="text-center my-10" style="height:10px;padding-top: 10px">Edit Book Details</H3>
...
<div class="d-md-flex h-100">
    <div class="container-fluid" style="align-content: center;">
        ...
        <form  class="form" id="Bookform"  action="${pageContext.request.contextPath}/updateBook" >
            <div class="row form-group">
                <div class="col-25">
                    <label  for="code"class="col-form-label">BookCode:</label>
                </div>
                <div class="col-75">
                    <input type="text"  class="form-control" id="code" name="bookcode" value="${book.bookcode}" readonly>
            </div>
            </div>
            <div class="row form-group">
                <div class="col-25">
            ...
            <div class="row form-group">
                ...
                <div class="col-75">
                <input type="text" class="form-control" id="dateadded" name="dateadded" value="${book.dateadded}">
            </div>
            </div>
